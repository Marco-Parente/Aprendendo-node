...
// logst.truncate should not throw if the log id doesn't exist
unit['logs.truncate should not throw if the log id doesnt exist, it should callback an error instead'] = function(done){
