...
workers.performCheck = function(originalCheckData){
    ...
    var path = parsedUrl.url; // Using path not pathname, because we want the querystring
    ...
    var _modulerToUse = originalCheckData.protocol == 'http' ? http : https;
    var req = _modulerToUse.request(requestDetails,function(res){
...
// Proccess the check outcome, update the check as needed, trigger an alert to the user if needed
...
// Time to execute the rotation proccess once per day
...
workers.init = function(){
    ...
    // Rotate logs, compress all the logs immediately
    workers.rotateLogs();

    // Call the compression loop, so logs will be comprassed later on
