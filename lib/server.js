   ...
   req.on('data',function(data){
    ...
    req.on('end', function(){
        ...
        try{
            ...
            debug(e);
            server.processHandlerResponse(res,method,trimmedPath,500,{'Error' : 'An unknown has ocurred'}, 'json'); 
        }
   });
};
...
server.processHandlerResponse = function(res, method, trimmedPath, statusCode, payload, contentType){
    ...
    // Return the response parts that are commom to all content-types
